package com.starter.template.config.mail;
...
@Configuration
@PropertySource("classpath:config/mail/emailconfig.properties")
public class MailSenderConfig implements ApplicationContextAware, EnvironmentAware {

    public static final String EMAIL_TEMPLATE_ENCODING = "UTF-8";

    private static final String JAVA_MAIL_FILE = "classpath:config/mail/javamail.properties";
    ...
    public ResourceBundleMessageSource emailMessageSource() {
        ...
        messageSource.setBasename("config/mail/MailMessages");
